...
public class EasyRamDBStore implements DataStore {
    ...
    private static final Logger logger = Logger.getLogger("EasyRamDBStore");
    public static String JOURNAL_VERSION = "EASYRAMVERSION_1";
   ...
   // protected ByteBuffer buffer = null;
    ...
    private EasyRamDBStore() { }

    // TODO: Need to add optional expected capacity
    public EasyRamDBStore(String folder, String name) {
        this(folder, name, Storage.IN_MEMORY, DEFAULT_JOURNAL_SIZE, true);
    }

    public EasyRamDBStore(String folder, String name, Storage type) {
		this(folder, name, type, DEFAULT_JOURNAL_SIZE, true);
    }

    public EasyRamDBStore(String folder, String name, Storage type, int sizeInBytes) {
    ...
    private void writeJournalHeader(RandomAccessFile journal) throws IOException {
        ...
        journal.writeUTF(EasyRamDBStore.JOURNAL_VERSION);
