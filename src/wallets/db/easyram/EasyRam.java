...
import db.paths.File_db;

/**
 *
 * @author ebruno
 */
public class EasyRam {
    ...
    protected final static int DEFAULT_STORE_SIZE = MEGABYTE * 100;
     ...
     String homeDirectory = 
    		File_db.returnHomeDir()+
            File.separator+"easyramDB";
    
    public EasyRam() {
    }
    
    public EasyRam(String homeDirectory) {
	...
	public  boolean createStore( String name, 
        ...
        EasyRamDBStore nohdb = new 
            EasyRamDBStore( homeDirectory, "bech-" + name + "-", 
                            storageType, 
                            size * MEGABYTE, true);
    ...
    public int getCollisions(String storeName) {
        EasyRamDBStore niop = (EasyRamDBStore)stores.get(storeName);
